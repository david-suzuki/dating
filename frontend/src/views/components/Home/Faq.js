...
export default function Faq({ id }) {
  ...
  const Result1 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        オフショア人材とAIによる自動処理を活用する事で、価格と品質を両立させています。
        <br />
        また、納品前には国内で品質管理を行っています。
      </p>
    </div>
  );
  const Result2 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        最終的な成果物の精度は、お客様からご提供頂く依頼データの精度に依存します。
      </p>
    </div>
  );
  const Result3 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        価格と納期はご依頼内容によって異なります。
        <br />
        詳しくはログイン後の、案件作成画面でご確認頂けます。
      </p>
    </div>
  );
  const Result4 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        精度10cm以下のグラウンドデータとオルソフォトが必要になります。
        <br />
        また、等高線があると品質が向上します。
      </p>
    </div>
  ...
  const Result5 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        ご提供頂くグラウンドデータとオルソ画像から読み取れる地物のみを一般図として図化します。
      </p>
    </div>
  );
  const Result6 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        写真測量・Lidar測量いずれも対応可能です。
        <br />
        お見積りが必要な場合は、ページ下部のお問合せフォームよりお気軽にご相談下さい。
      </p>
    </div>
  );
  const Result7 = () => (
    <div>
      <p style={{ fontSize: "16px", paddingLeft: "25px" }}>
        ご利用の際にはGoogle Chromeをご使用下さい。
        <br />
        それ以外のブラウザによっては、正しくご利用できない場合があります。
      </p>
    </div>
  );

  return (
    <div style={{ padding: "80px 20%", backgroundColor: "white" }} id={id}>
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            <h4>
              <b>Q. 価格が安いですが、成果物の品質に問題はないですか？</b>
            </h4>
            {showResult1 ? <Result1 /> : null}
            {showPlusBtn1 ? (
              <button className={classes.plusBtn} onClick={onShow1}>
            ...
            {showMinusBtn1 ? (
              <button className={classes.minusBtn} onClick={onHide1}>
        ...
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            <h4>
              <b>Q. 成果物の精度はどれくらいですか？</b>
            </h4>
            {showResult2 ? <Result2 /> : null}
            {showPlusBtn2 ? (
              <button className={classes.plusBtn} onClick={onShow2}>
                <i className="fa fa-plus" aria-hidden="true"></i>
              </button>
            ) : (
              true
            ...
            {showMinusBtn2 ? (
              <button className={classes.minusBtn} onClick={onHide2}>
                <i className="fa fa-minus" aria-hidden="true"></i>
              </button>
            ) : null}
          </div>
        ...
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            <h4>
              <b>Q. 詳しい価格と納期について教えて下さい。</b>
            </h4>
            {showResult3 ? <Result3 /> : null}
            {showPlusBtn3 ? (
              <button className={classes.plusBtn} onClick={onShow3}>
                <i className="fa fa-plus" aria-hidden="true"></i>
              </button>
            ) : (
              true
            ...
            {showMinusBtn3 ? (
              <button className={classes.minusBtn} onClick={onHide3}>
                <i className="fa fa-minus" aria-hidden="true"></i>
              </button>
            ) : null}
          </div>
        ...
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            ...
            {showPlusBtn4 ? (
              <button className={classes.plusBtn} onClick={onShow4}>
                <i className="fa fa-plus" aria-hidden="true"></i>
              </button>
            ) : (
              true
            ...
            {showMinusBtn4 ? (
              <button className={classes.minusBtn} onClick={onHide4}>
                <i className="fa fa-minus" aria-hidden="true"></i>
              </button>
            ) : null}
          </div>
        ...
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            <h4>
              <b>Q. 図化対象には全ての地物が含まれますか？</b>
            </h4>
            {showResult5 ? <Result5 /> : null}
            {showPlusBtn5 ? (
              <button className={classes.plusBtn} onClick={onShow5}>
                <i className="fa fa-plus" aria-hidden="true"></i>
              </button>
            ) : (
              true
            ...
            {showMinusBtn5 ? (
              <button className={classes.minusBtn} onClick={onHide5}>
                <i className="fa fa-minus" aria-hidden="true"></i>
              </button>
            ) : null}
          </div>
        ...
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            <h4>
              <b>Q. 計測作業からお願いする事はできますか？</b>
            </h4>
            {showResult6 ? <Result6 /> : null}
            {showPlusBtn6 ? (
              <button className={classes.plusBtn} onClick={onShow6}>
                <i className="fa fa-plus" aria-hidden="true"></i>
              </button>
            ) : (
              true
            ...
            {showMinusBtn6 ? (
              <button className={classes.minusBtn} onClick={onHide6}>
                <i className="fa fa-minus" aria-hidden="true"></i>
              </button>
            ) : null}
          </div>
        ...
        <GridItem xs={12} sm={12} className={classes.marginBT}>
          ...
          >
            <h4>
              <b>Q. 利⽤する際の推奨ブラウザについて教えて下さい。</b>
            </h4>
            {showResult7 ? <Result7 /> : null}
            {showPlusBtn7 ? (
              <button className={classes.plusBtn} onClick={onShow7}>
                <i className="fa fa-plus" aria-hidden="true"></i>
              </button>
            ) : (
              true
            ...
            {showMinusBtn7 ? (
              <button className={classes.minusBtn} onClick={onHide7}>
                <i className="fa fa-minus" aria-hidden="true"></i>
              </button>
            ) : null}
          </div>
