...
<body>
	<div style="text-align:center; font-size:20px;font-weight: bold">発　注　請　書</div>
	<br />
    ...
    <div style="width: 100%; height: auto; margin-top: 20px;">
        <div style="float: left; width: 66%; height: auto; padding-right: 30px;">
            ...
            <div style="width: 100%; height: 120px; border-top: 2px solid black; text-align: center; padding-top: 0px;">下記のとおり、御注文をお請け致しました。
            </div>
            <div style="width: 100%; height: 40px; margin-bottom: 10px;">
                <div style="width: 20%; float: left; text-align: right;">
                    納期：
                </div>
                <div style="width: 76%; float: right; height: 30px;border-bottom: 2px solid black">{{ $data['delivery_date'] }}</div>
            </div>
            <div style="width: 100%; height: 40px;">
                <div style="width: 20%; float: left; text-align: right;">
                    支払条件：
                </div>
                <div style="width: 76%; float: right; height: 30px; border-bottom: 2px solid black">検収完了月末締め翌月末払い</div>
            </div>
            ...
            <!-- <div style="width: 100%; height: 1px; border-top: 2px solid black; margin-top: 80px;"></div> -->
        </div>
        <div style="float: right; width: 30%; height: auto;">
            <p>発注No.{{ $data['no'] }}</p>
            <p>発行日.{{ $data['created_date'] }}</p>
            <br />
